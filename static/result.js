...
function parseAnalysis(text) {
    ...
    const resultMatch = text.match(
        /RESULT:\s*(AUTHENTIC|SUSPICIOUS|REJECTED)/i
    );
...
resultSubtitle.textContent =
    parsed.confidence + '% confidence · ' + data.doc_type;
...
parsed.checks.forEach(check => {
    ...
    div.className =
        'check-item ' + check.status.toLowerCase();
